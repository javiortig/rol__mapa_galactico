...
export function RecruitmentModal({
  ...
  return (
    <div className="pointer-events-auto fixed inset-0 z-40 grid place-items-center bg-black/58 p-0 backdrop-blur-sm md:px-4 md:py-6">
      <Panel className="flex h-[var(--app-height)] w-full max-w-5xl flex-col overflow-hidden rounded-none md:h-auto md:max-h-[88vh] md:rounded-lg">
        <div className="shrink-0 flex items-center justify-between gap-4 border-b border-cyan-200/15 px-4 pb-4 pt-[max(1rem,env(safe-area-inset-top))] md:p-5">
          <div>
        ...
        <div className="mobile-scroll flex-1 lg:grid lg:grid-cols-[1fr_320px] lg:grid-rows-none lg:overflow-hidden">
          ...
          <aside className="flex min-h-0 flex-col border-t border-cyan-200/15 bg-slate-950/32 lg:max-h-none lg:border-l lg:border-t-0">
            <div className="shrink-0 border-b border-cyan-200/15 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-4 md:p-5">
            ...
            <div className="p-4 md:p-5 lg:min-h-0 lg:flex-1 lg:overflow-y-auto">
