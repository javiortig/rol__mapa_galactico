...
const technologyNodes: CampaignSnapshot["technologyNodes"] = [
  ...
  makeTechnologyNode({ id: "monumentos-gloria", slug: "monumentos-gloria", name: "Monumentos a la Gloria", description: "Arquitectura ceremonial para convertir victorias y lealtad en Honor.", branch: "Progreso", tier: 2, positionX: 73, positionY: 71, costTechnology: 1, researchTimeSeconds: 7200, iconKey: "honor", effectSummary: "Desbloquea Monumento.", isStarter: false }),
  makeTechnologyNode({ id: "custodia-reliquias", slug: "custodia-reliquias", name: "Custodia de Reliquias", description: "Protocolos de sellado, inventario y escolta para custodiar artefactos sagrados de campana.", branch: "Progreso", tier: 3, positionX: 86, positionY: 72, costTechnology: 1, researchTimeSeconds: 7200, iconKey: "relic_sanctuary", effectSummary: "Desbloquea Santuario de Reliquias.", isStarter: false }),
...
const technologyEffects: CampaignSnapshot["technologyEffects"] = [
  ...
  { id: "effect-custodia-relic-sanctuary", technologyNodeId: "custodia-reliquias", effectType: "unlock_building_template", payload: { buildingTemplateSlugs: ["santuario-reliquias"] } },
...
const buildingTemplates: CampaignSnapshot["buildingTemplates"] = [
  makeBuildingTemplate({ id: "barracon-infanteria", name: "Barracon de Infanteria", category: "Reclutamiento", description: "Centro de instruccion para tropas de linea y cuadros veteranos.", buildingKind: "recruitment", industrialMaterialCost: 25, constructionTimeSeconds: 86400, allowedUnitCategories: ["Infanteria", "Elite"], requiredTechnologyNodeId: "fundacion-planetaria", iconKey: "infantry_barracks" }),
  makeBuildingTemplate({ id: "cuartel-mando", name: "Cuartel de Mando", category: "Reclutamiento", description: "Instalacion de oficiales, heroes y personajes de mando.", buildingKind: "recruitment", industrialMaterialCost: 53, constructionTimeSeconds: 259200, allowedUnitCategories: ["Personaje"], requiredTechnologyNodeId: "asamblea-planetaria", iconKey: "command_quarters" }),
  makeBuildingTemplate({ id: "camara-leyendas", name: "Camara de Leyendas", category: "Reclutamiento", description: "Camara sellada para reclutar unidades [Crucible] cuando su tecnologia deje de estar bloqueada.", buildingKind: "recruitment", industrialMaterialCost: 70, constructionTimeSeconds: 259200, allowedUnitCategories: ["Personaje", "Linea de batalla", "Transporte", "Otras hojas de datos", "Aliada", "Infanteria", "Elite", "Vehiculo", "Monstruo", "Hoja de datos", "Otro", "Superpesado"], requiredTechnologyNodeId: "camara-leyendas", iconKey: "legend_chamber" }),
  makeBuildingTemplate({ id: "taller-guerra", name: "Taller de Guerra", category: "Reclutamiento", description: "Bahias de reparacion y ensamblaje de vehiculos.", buildingKind: "recruitment", industrialMaterialCost: 48, constructionTimeSeconds: 259200, allowedUnitCategories: ["Vehiculo"], requiredTechnologyNodeId: "maquinaria-belica", iconKey: "war_workshop" }),
  makeBuildingTemplate({ id: "nido-bestias", name: "Nido de Bestias", category: "Reclutamiento", description: "Jaulas y rituales de control para monstruos de guerra.", buildingKind: "recruitment", industrialMaterialCost: 48, constructionTimeSeconds: 259200, allowedUnitCategories: ["Monstruo"], requiredTechnologyNodeId: "criadero-guerra", iconKey: "beast_lair" }),
  makeBuildingTemplate({ id: "camara-comercio", name: "Camara de Comercio", category: "Comercio", description: "Mercado orbital y punto de contacto con rutas mercantes.", buildingKind: "commerce", industrialMaterialCost: 38, constructionTimeSeconds: 172800, requiredTechnologyNodeId: "pactos-mercantiles", iconKey: "commerce" }),
  makeBuildingTemplate({ id: "nexo-inteligencia", name: "Nexo de Inteligencia", category: "Inteligencia", description: "Centro de analisis para operaciones de espionaje futuras.", buildingKind: "intelligence", industrialMaterialCost: 48, constructionTimeSeconds: 259200, requiredTechnologyNodeId: "oficina-inteligencia", iconKey: "intelligence" }),
  makeBuildingTemplate({ id: "antenas-reconocimiento", name: "Antenas de Reconocimiento", category: "Inteligencia", description: "Matrices de escucha y auspex de largo alcance.", buildingKind: "intelligence", industrialMaterialCost: 38, constructionTimeSeconds: 172800, requiredTechnologyNodeId: "celulas-informacion", iconKey: "recon" }),
  makeBuildingTemplate({ id: "granja-biologica", name: "Granja Biologica", category: "Produccion", description: "Complejos de biomasa y cultivos adaptados al frente.", buildingKind: "production", industrialMaterialCost: 25, constructionTimeSeconds: 86400, producedResourceKey: "supply", producedAmount: 0, requiredTechnologyNodeId: "fundacion-planetaria", iconKey: "biofarm" }),
  makeBuildingTemplate({ id: "complejo-minero", name: "Complejo Minero", category: "Produccion", description: "Pozos, excavadoras y refinerias de mineral bruto.", buildingKind: "production", industrialMaterialCost: 25, constructionTimeSeconds: 86400, producedResourceKey: "minerals", producedAmount: 0, requiredTechnologyNodeId: "extraccion-subterranea", iconKey: "mine" }),
  makeBuildingTemplate({ id: "refineria-iridium", name: "Refineria de Iridium", category: "Produccion", description: "Planta especializada para estabilizar cristales de salto.", buildingKind: "production", industrialMaterialCost: 33, constructionTimeSeconds: 172800, producedResourceKey: "uridium", producedAmount: 0, requiredTechnologyNodeId: "cristalizacion-combustible-cuantico", iconKey: "iridium_refinery" }),
  makeBuildingTemplate({ id: "mina-oro", name: "Mina de Oro", category: "Produccion", description: "Extraccion de metales preciosos para rutas comerciales.", buildingKind: "production", industrialMaterialCost: 43, constructionTimeSeconds: 172800, producedResourceKey: "gold", producedAmount: 0, requiredTechnologyNodeId: "fiebre-oro", iconKey: "gold_mine" }),
  makeBuildingTemplate({ id: "planta-fundicion", name: "Planta de Fundicion", category: "Produccion", description: "Produce Material Industrial para nuevas construcciones.", buildingKind: "production", industrialMaterialCost: 25, constructionTimeSeconds: 86400, producedResourceKey: "industrialMaterial", producedAmount: 0, requiredTechnologyNodeId: "procesado-metalurgico", iconKey: "foundry" }),
  makeBuildingTemplate({ id: "monumento", name: "Monumento", category: "Produccion", description: "Estructura ceremonial que transforma gloria local en Honor.", buildingKind: "production", industrialMaterialCost: 30, constructionTimeSeconds: 172800, producedResourceKey: "honor", producedAmount: 0, requiredTechnologyNodeId: "monumentos-gloria", iconKey: "monument" }),
  makeBuildingTemplate({ id: "santuario-reliquias", name: "Santuario de Reliquias", category: "Reliquias", description: "Camara sellada donde se custodian reliquias narrativas y se equipan a Caracteres veteranos.", buildingKind: "relic", industrialMaterialCost: 55, constructionTimeSeconds: 259200, requiredTechnologyNodeId: "custodia-reliquias", iconKey: "relic_sanctuary" })
];
