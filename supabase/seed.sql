...
values
  (public.seed_uuid('technology_node', 'doctrina-campana'), 'doctrina-campana', 'common-v1', 'Doctrina de campana', 'Protocolos basicos para sostener una campana galactica en tiempo real.', 'Mando y doctrina', 0, 10, 15, 0, 0, 'command', 'Base doctrinal desbloqueada.', true),
  (public.seed_uuid('technology_node', 'logistica-frente'), 'logistica-frente', 'common-v1', 'Logistica de frente', 'Ajusta rutas de suministro, convoyes y reservas para mantener infanteria en movimiento.', 'Mando y doctrina', 1, 30, 11, 4, 120, 'supply', '-10% Suministro al reclutar Infanteria.', false),
  (public.seed_uuid('technology_node', 'cadenas-mando'), 'cadenas-mando', 'common-v1', 'Cadenas de mando', 'Vox, protocolos de enlace y oficiales de enlace reducen demoras de despliegue.', 'Mando y doctrina', 1, 30, 19, 4, 120, 'command', '-10% tiempo al reclutar Infanteria.', false),
  (public.seed_uuid('technology_node', 'estado-mayor-cruzada'), 'estado-mayor-cruzada', 'common-v1', 'Estado mayor de cruzada', 'Permite coordinar instalaciones de mando estables para una campana prolongada.', 'Mando y doctrina', 3, 72, 15, 12, 360, 'command', 'Desbloquea Bastion de mando.', false),

  (public.seed_uuid('technology_node', 'entrenamiento-linea'), 'entrenamiento-linea', 'common-v1', 'Entrenamiento de linea', 'Organizacion minima para reclutar tropas basicas de cada faccion.', 'Infanteria y elite', 0, 10, 34, 0, 0, 'infantry', 'Unidades basicas desbloqueadas.', true),
  (public.seed_uuid('technology_node', 'veteranos-guerra'), 'veteranos-guerra', 'common-v1', 'Veteranos de guerra', 'Permite desplegar cuadros veteranos, elites y tropas endurecidas.', 'Infanteria y elite', 1, 30, 34, 4, 120, 'elite', 'Desbloquea unidades elite actuales.', false),
  (public.seed_uuid('technology_node', 'especializacion-elite'), 'especializacion-elite', 'common-v1', 'Especializacion de elite', 'Cadenas de municion, equipo y entrenamiento para unidades de alto valor.', 'Infanteria y elite', 2, 51, 34, 8, 240, 'elite', '-10% Mineral al reclutar Elite.', false),
  (public.seed_uuid('technology_node', 'honores-batalla'), 'honores-batalla', 'common-v1', 'Honores de batalla', 'Registros, juramentos y marcas de campana para futuras mejoras narrativas.', 'Infanteria y elite', 3, 72, 34, 12, 360, 'honor', 'Reserva para mejoras narrativas.', false),

  (public.seed_uuid('technology_node', 'talleres-campana'), 'talleres-campana', 'common-v1', 'Talleres de campana', 'Instala lineas de mantenimiento para maquinas, vehiculos y andadores.', 'Blindados y maquinas', 1, 30, 50, 4, 120, 'forge', 'Desbloquea Taller de campana.', false),
  (public.seed_uuid('technology_node', 'motores-guerra'), 'motores-guerra', 'common-v1', 'Motores de guerra', 'Habilita blindados, dreadnoughts y maquinas de guerra en el teatro activo.', 'Blindados y maquinas', 2, 51, 50, 8, 240, 'vehicle', 'Desbloquea vehiculos actuales.', false),
  (public.seed_uuid('technology_node', 'blindaje-reforzado'), 'blindaje-reforzado', 'common-v1', 'Blindaje reforzado', 'Estandariza placas, chasis, reparaciones y blindajes de campana.', 'Blindados y maquinas', 3, 72, 50, 12, 360, 'vehicle', '-10% Mineral al reclutar Vehiculos.', false),
  (public.seed_uuid('technology_node', 'arsenal-pesado'), 'arsenal-pesado', 'common-v1', 'Arsenal pesado', 'Infraestructura reservada para superpesados y activos de asedio futuros.', 'Blindados y maquinas', 4, 90, 50, 18, 600, 'arsenal', 'Reserva para superpesados futuros.', false),

  (public.seed_uuid('technology_node', 'nodo-logistico'), 'nodo-logistico', 'common-v1', 'Nodo logistico', 'Red de hangares, almacenes y puntos de transferencia orbital.', 'Infraestructura', 1, 30, 66, 4, 120, 'infrastructure', 'Desbloquea Nodo logistico.', false),
  (public.seed_uuid('technology_node', 'manufactorum-local'), 'manufactorum-local', 'common-v1', 'Manufactorum local', 'Convierte sistemas controlados en puntos de fabricacion y ensamblaje.', 'Infraestructura', 2, 51, 66, 8, 240, 'factory', 'Desbloquea Manufactorum.', false),
  (public.seed_uuid('technology_node', 'red-suministro'), 'red-suministro', 'common-v1', 'Red de suministro', 'Futura mejora de produccion y sostenimiento territorial.', 'Infraestructura', 3, 72, 66, 12, 360, 'supply', 'Reserva para bonus de produccion.', false),
  (public.seed_uuid('technology_node', 'puerto-uridium'), 'puerto-uridium', 'common-v1', 'Puerto de Uridium', 'Infraestructura futura para optimizar rutas de salto y gasto de Uridium.', 'Infraestructura', 4, 90, 66, 18, 600, 'uridium', 'Reserva para bonus de movimiento.', false),

  (public.seed_uuid('technology_node', 'auspex-reliquias'), 'auspex-reliquias', 'common-v1', 'Auspex de reliquias', 'Patrones de lectura para detectar senales raras y artefactos antiguos.', 'Arqueotecnologia', 1, 30, 84, 4, 120, 'auspex', 'Reserva para deteccion de reliquias.', false),
  (public.seed_uuid('technology_node', 'nucleos-datos'), 'nucleos-datos', 'common-v1', 'Nucleos de datos', 'Matrices de calculo para exprimir componentes tecnologicos recuperados.', 'Arqueotecnologia', 2, 51, 84, 8, 240, 'data', 'Reserva para bonus de Componentes tecnologicos.', false),
  (public.seed_uuid('technology_node', 'matrices-eficiencia'), 'matrices-eficiencia', 'common-v1', 'Matrices de eficiencia', 'Optimizacion transversal de costes de produccion militar.', 'Arqueotecnologia', 3, 72, 84, 12, 360, 'matrix', '-5% coste general de reclutamiento.', false),
  (public.seed_uuid('technology_node', 'cifra-negra'), 'cifra-negra', 'common-v1', 'Cifra negra', 'Tecnologia avanzada sellada para fases futuras de la campana.', 'Arqueotecnologia', 4, 90, 84, 18, 600, 'cipher', 'Reserva avanzada futura.', false)
on conflict (slug) do update
