...
- Los jugadores no eligen control final ni bloqueo posterior: el control queda en manos del vencedor y el bloqueo estandar es de 7 dias. Solo admin puede corregir esos valores si hace falta.
...
- Notas narrativas.
- Duracion de bloqueo posterior: 7 dias por defecto, corregible por admin.
...
- El bloqueo posterior estandar tras aplicar una batalla es de 7 dias.
